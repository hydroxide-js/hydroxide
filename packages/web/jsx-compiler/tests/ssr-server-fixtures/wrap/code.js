...
const exprTest = (
  <div>
    ...
    <Info foo={props.foo} $:bar={foo.bar}>
      {' '}
      {bar.bazz}{' '}
    </Info>
  </div>
...
const idTest = (
  <div>
    <p title={title} on-click={handleClick}>
      {' '}
      {site}{' '}
    </p>
    <Info onRemove={handleRemove} ref={bar}>
      {' '}
      {mapping}{' '}
    </Info>
  </div>
...
const callTest = (
  <div>
    <p title={title()} on-click={createHandler()}>
      {' '}
      {site}{' '}
    </p>
    <Info onRemove={foo()} ref={bar()}>
      {' '}
      {createMapping()}{' '}
    </Info>
  </div>
