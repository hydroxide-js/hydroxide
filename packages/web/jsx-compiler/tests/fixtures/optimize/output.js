import { template as _template, insert as _insert } from 'hydroxide-dom'
const _tmpl = /*#__PURE__*/ _template('<div>AAA BBB</div>'),
  ...
  _tmpl0 = /*#__PURE__*/ _template('<div>QQQ</div>'),
  _tmpl1 = /*#__PURE__*/ _template('<div><!> <!> <!> <!></div>'),
  _tmpl10 = /*#__PURE__*/ _template('<div>AAA true <!> BBB 100 <!> <!> <!></div>')
const test1 = /*#__PURE__*/ _tmpl.cloneNode(true)
// extra whitespaces should be removed

const test2 = /*#__PURE__*/ _tmpl2.cloneNode(true)
// extra whitespace should not be removed from expression container

const test3 = /*#__PURE__*/ _tmpl3.cloneNode(true)
// extra whitespace should not be removed from expression container
...
const test6 = /*#__PURE__*/ _tmpl6.cloneNode(true)
...
const test12 = /*#__PURE__*/ (() => {
  const _root6 = _tmpl10.cloneNode(true),
    _node9 = _root6.firstChild.nextSibling,
    _node0 = _node9.nextSibling.nextSibling,
    _node1 = _node0.nextSibling.nextSibling,
    _node10 = _node1.nextSibling.nextSibling
  _insert(_node9, x)
  _insert(_node0, y)
  _insert(_node1, z)
  _insert(_node10, p)
