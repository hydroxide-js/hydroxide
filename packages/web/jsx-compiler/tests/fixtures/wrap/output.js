import { branch as _branch, delegateEvents as _delegateEvents } from 'hydroxide-dom'
...
const _tmpl = /*#__PURE__*/ _template(
  ...
  _tmpl0 = /*#__PURE__*/ _template('<div><!></div>'),
  _tmpl1 = /*#__PURE__*/ _template('<div><p><!></p><!></div>')
// don't wrap literals
...
const pureIIFE = /*#__PURE__*/ (() => {
  const _root7 = _tmpl8.cloneNode(true),
    _node11 = _root7.firstChild
  _insert(
    _node11,
    _component(Foo, {
      bar: /*#__PURE__*/ (() => {
        const _root6 = _tmpl7.cloneNode(true),
          _node10 = _root6.firstChild
        _insert(_node10, bar)
        return _root6
      })()
    })
...
const cloneNode = /*#__PURE__*/ (() => {
  const _root8 = _tmpl0.cloneNode(true),
    _node12 = _root8.firstChild
  _insert(
    _node12,
    _component(Foo, {
...
const unreactive = /*#__PURE__*/ (() => {
  const _root9 = _tmpl1.cloneNode(true),
    _node13 = _root9.firstChild,
    _node14 = _node13.firstChild,
    _node15 = _node13.nextSibling
  _effect(() => _setAttribute(_node13, 'title', foo + bar), 3)
  _insert(_node14, x === y)
  _insert(
    _node15,
    _component(Info, {
